...
from experiment_result import ExperimentResult, ExperimentResultTimestep, ExperimentResultSummary
...
class ExperimentRunner:
    ...
    def run(self) -> ExperimentResult:
        ...
        for i in range(self.max_timesteps):
            ...
            measured_state_brt_value = float(map.get_brt_value(system.state)),
            ...
            result_timestep = ExperimentResultTimestep(
                index = i,
                time = i * system.timestep,
                current_state_measurement = measured_state,
                current_state_brt_value = measured_state_brt_value,
                ...
                control_is_from_safety_filter = safety_filter_activated,
            ...
            result.capture_timestep(result_timestep)
